...
Code for the Stellar winds atlas paper for black hole formation. It uses the [StarEstate population synthesis tool](https://github.com/AmedeoRom/StarEstate) to generate entire populations of single stars for the Milky Way or elliptical galaxies (the galaxy shape is irrelevant in this paper).
